...
const checkValid =(name,value)=>{
  ...
  if (check) {
    ...
    const url = `${process.env.NEXT_PUBLIC_API_ENDPOINT}admin/masters/location/state/create`;
  ...
  return (
    <>
      ...
      <Modal show={show} onHide={onRequestClose}>
        <Modal.Header>
        <h5 className="modal-title" id="exampleModalLabel">Add State</h5>
                    ...
                    <div className="col-md-12 form-group mb-3">
                        ...
                        <div className="col-md-12 form-group mb-3">
                            ...
                            <input value={formData.name} className={errors && errors.name ? "form-control is-invalid" : "form-control"} 
                             name="name" onChange={handleValidation}  type="text" placeholder="State Name" />
