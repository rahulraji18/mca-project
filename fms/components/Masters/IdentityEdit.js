...
const checkValid =(name,value)=>{
  ...
  if (check) {
    ...
    const url = `${process.env.NEXT_PUBLIC_API_ENDPOINT}admin/masters/identity/update`;
  ...
  return (
    <>
      ...
      <Modal show={show} onHide={onRequestClose}>
        <Modal.Header>
        <h5 className="modal-title" id="exampleModalLabel">Edit Identity</h5>
                ...
                <form id="form001">
                    <div className="row">
                        ...
                        <div className="col-md-12 form-group mb-3">
                            <label htmlFor="firstName1">Identity Name</label>
