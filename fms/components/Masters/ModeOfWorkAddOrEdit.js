...
const AddModal = ({ val, onRequestClose, isEditModal, data }) => {
  ...
  const saveSubmit = async (e) => {
    ...
    if (check) {
      ...
      {
        isEditModal && body.append("id", formData.employee_type_id);
      }
      ...
      }admin/masters/mode-of-work/${isEditModal ? "update" : "store"}`;
      ...
      <Modal show={show} onHide={onRequestClose}>
        <Modal.Header>
          <h5 className="modal-title" id="exampleModalLabel">
            {isEditModal ? "Edit mode of work" : "Add mode of work"}
          </h5>
          ...
          <form id="form01">
            <div className="row">
              <div className="col-md-12 form-group mb-3">
                <label htmlFor="firstName1">Mode of work</label>
                <input
                  value={formData.name}
                  className={
                    errors && errors.name
