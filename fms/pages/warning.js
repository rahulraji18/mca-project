...
const WarningMessage = () => {
  return (
    <Fragment>
      <Seo title="Warning Message" />

      <div className="page main-signin-wrapper bg-info br-0-f">
            ...
            <Card className="card alert-message">
              <Card.Body>
                <div className="text-center text-white">
                  ...
                  <h3 className="mt-4 mb-3">Message Warning</h3>
...
WarningMessage.layout = "Authenticationlayout";
