...
import {
  Slicksider,
  Slicksiderwithdata,
} from "../../../shared/data/landingpagedata/landingpagedata";
import dynamic from "next/dynamic";
const Navbar1 = dynamic(
  () => import("../../../shared/data/landingpagedata/navbar"),
  { ssr: false }
);
...
import market3 from "../../../public/assets/landing/images/market3.png";
import frequentlyaskedquestions from "../../../public/assets/landing/images/frequently-asked-questions.png";
import Seo from "../../../shared/layout-components/seo/seo";
const Landingpagecom = dynamic(()=>import('../../../shared/data/landingpagedata/landingpagecom'), { ssr: false })

const Landingpage = () => {
  let [isFirstCollapsed, setisFirstCollapsed] = useState(false);
  let [is2Collapsed, setis2Collapsed] = useState(false);
  let [is3tCollapsed, setis3Collapsed] = useState(false);
  let [is4Collapsed, setis4Collapsed] = useState(false);
  let [is5Collapsed, setis5Collapsed] = useState(false);
  let [is6Collapsed, setis6Collapsed] = useState(false);
  let [is7Collapsed, setis7Collapsed] = useState(false);
  let [is8Collapsed, setis8Collapsed] = useState(false);
  let [is9Collapsed, setis9Collapsed] = useState(false);
  let [is10Collapsed, setis10Collapsed] = useState(false);
  ...
  return (
          ...
          <div className="page-main">
                ...
                <div className="main-header-center">
                  <div className="responsive-logo">
                    <Link href={`/components/dashboard/dashboard`}>
                      <img src={logo.src} className="mobile-logo" alt="lo/o" />
                    </Link>
                    <Link href={`/components/dashboard/dashboard`}>
                      <img
                        src={logolight.src}
                  ...
                  <Row>
                    <Col xl={6} lg={6} className="animation-zidex pos-relative">
                      ...
                      <Link
                        ...
                        href="#"
                      >
                        <i className="fe fe-play me-2 d-inline-flex"></i>
                        Get Started
                      </Link>
                      <Link
                      ...
                      >
                        <i className="fe fe-eye me-2 d-inline-flex"></i>
                        Discover More
                      </Link>
                    </Col>
                    <Col xl={6} lg={6} className="my-auto">
                      <img src={market3.src} alt="market" />
                    </Col>
                  </Row>
                </Container>
              </div>
            ...
            <div className="main-content mt-0">
              <div className="side-app">
                          ...
                          >
                            <Card.Body>
                              ...
                              <div className="text-left counter-body">
                                ...
                                <p className="mb-0">
                                  The most advanced {`"User Pages"`} are
                                  included in this template, like registration,
                                                ...
                                                <div className="counter-status">
                                                  ...
                                                  <div className="test-body text-center">
                                                    <h1 className=" mb-0">
                                                      ...
                                                      <div className='h2'><SlotCounter value={100} /></div>
                                                      </span>
                                                    </h1>
                                              ...
                                              <div className="bg-transparent">
                                                <div className="counter-status">
                                                  ...
                                                  <div className="test-body text-center">
                                                    <h1 className=" mb-0">
                                                      <span className="counter fw-semibold counter">
                                                      <p className='h2'><SlotCounter value={60.32} duration={2} /></p>
                                                      </span>
                                                    </h1>
                                                    <div className="counter-text">
                                                      <h5 className="font-weight-normal mb-0">
                                              ...
                                              <div className="bg-transparent">
                                                <div className="counter-status">
                                                  ...
                                                  <div className="test-body text-center">
                                                    <h1 className=" mb-0">
                                                      <span className="counter fw-semibold counter">
                                                      <p className='h2'><SlotCounter value={10} duration={2} /></p>
                                                      </span>
                                                    </h1>
                                                    <div className="counter-text">
                                                      <h5 className="font-weight-normal mb-0">
                                              ...
                                              <div className="bg-transparent">
                                                <div className="counter-status">
                                                  ...
                                                  <div className="test-body text-center">
                                                    <h1 className=" mb-0">
                                                      <span className="counter fw-semibold counter">
                                                      <p className='h2'><SlotCounter value={30} duration={2} /></p>
                                                      </span>
                                                    </h1>
                                                    <div className="counter-text">
                                                      <h5 className="font-weight-normal mb-0">
                ...
                <div className="section bg-landing working-section" id="About">
                  <Container>
                    <Row>
                      <h4 className="text-center fw-semibold landing-card-header">
                        Our Mission
                                ...
                                >
                                  <g data-name="Web Design and Development">
                                    ...
                                    <rect
                                      ...
                                      fill="#cccacb"
                                    />
                                    <path d="M604.60322,126.67633v245.1499a22.76013,22.76013,0,0,1-22.76,22.7603h-358.01v-249.23a18.6886,18.6886,0,0,1,18.68-18.6802Z" />
                                    <path
                                      fill="#f2f2f2"
                                    ...
                                    />
                                    <path d="M138.40882,137.71023h122.208a7.2954,7.2954,0,0,1,7.2954,7.2954v195.6753a7.2954,7.2954,0,0,1-7.2954,7.2954H138.40832a7.2954,7.2954,0,0,1-7.2954-7.2954V145.00613A7.2959,7.2959,0,0,1,138.40882,137.71023Z" />
                                    <path
                                      fill="#cde7fe"
                                    ...
                                    />
                                    <path d="M568.72842,188.04323h-81.0867c-4.5562,0-8.2495,4.3292-8.2495,9.6697v163.6585c0,5.3405,3.6933,9.6697,8.2495,9.6697h81.0867c4.556,0,8.2495-4.3292,8.2495-9.6697V197.71293C576.97792,192.37243,573.28442,188.04323,568.72842,188.04323Z" />
                                    <path
                                      fill="#8d7de0"
                                    ...
                                    />
                                    <path d="M290.225,278.61883h86.29a4.1755,4.1755,0,0,1,4.1755,4.1755v86.2903a4.1752,4.1752,0,0,1-4.1752,4.1752h-86.2906a4.1752,4.1752,0,0,1-4.1752-4.1752v-86.2903A4.1755,4.1755,0,0,1,290.225,278.61883Z" />
                                    <path
                                      fill="#caddfe"
                                ...
                                >
                                  <g id="Website_Blog">
                                    ...
                                    <g>
                                      <path
                                        fill="#fec9ac"
                                        d="M204.8528748,237.3587646l-5.8874359,4.0392303l-3.4229279-1.5063019
    ...
    C204.8870239,234.706131,204.8528748,237.050827,204.8528748,237.3587646z"
                                      ...
                                      <path
                                        fill="#ffab90"
                                        d="M204.8014679,231.2489471c-2.6356049,1.2493286-5.5622406,1.8480988-8.4717407,1.7114563
    ...
    C204.6816559,226.9874268,204.7673187,228.9211731,204.8014679,231.2489471z"
                                        opacity=".5"
                                      />
                                      <path
                                        fill="#3a4146"
                                        d="M207.7962799,243.9229126c-0.0791779,0.5315704-0.5429535,0.9049225-1.0858459,0.9049225h-26.5124207
    ...
    C204.6816559,226.9874268,204.7673187,228.9211731,204.8014679,231.2489471z"
        ...
        C208.2826385,235.1457672,208.1808167,241.6381226,207.7962799,243.9229126z"
                                      ...
                                      <path
                                        fill="#c16244"
                                        d="M276.4532471,158.838623c-0.5418396,0.9288635-1.2496033,1.802536-2.2006226,2.3111725
...
C278.4990234,151.8606873,278.2447205,155.7643433,276.4532471,158.838623z"
                                      ...
                                      <path
                                        fill="#022e4f"
                                        d="M227.8056335,177.3699646c0,0-27.3431702,3.148056-31.3007355,9.6240692
...
"
                                      ...
                                      <g>
                                        <path
                                          fill="#a698bb"
                                          d="M262.89151,209.058136v33.8660126c0,0.9068756-0.7408752,1.6477051-1.6587524,1.6477051h-42.1325684
...
h42.1325684C262.1506348,207.4104462,262.89151,208.151535,262.89151,209.058136z"
                                      ...
                                      <g>
                                        <path
                                          fill="#fec9ac"
                                          d="M214.9947205,237.3587646l-5.8874359,4.0392303l-3.4229126-1.5063019
        ...
        C215.0288696,234.706131,214.9947205,237.050827,214.9947205,237.3587646z"
                                        ...
                                        <path
                                          fill="#ffab90"
                                          d="M214.9433289,231.2489471c-2.6356201,1.2493286-5.5622559,1.8480988-8.471756,1.7114563
        c-0.3080597-0.0171356-0.6332397-0.034256-0.9412842-0.0856476c-0.0341644-3.1663818-0.085556-5.9901276-0.085556-6.161438
        c0-0.4278564,8.796936,0.0856628,9.2076721,0.2227173
        C214.8235168,226.9874268,214.9091644,228.9211731,214.9433289,231.2489471z"
                                          opacity=".5"
                                        />
                                        <path
                                          fill="#3a4146"
                                          d="M217.9381256,243.9229126c-0.0791779,0.5315704-0.5429535,0.9049225-1.0858459,0.9049225H190.339859
        ...
        C214.8235168,226.9874268,214.9091644,228.9211731,214.9433289,231.2489471z"
            ...
            C218.4244843,235.1457672,218.3226624,241.6381226,217.9381256,243.9229126z"
                                        ...
                                        <path
                                          fill="#003567"
                                          d="M253.458725,207.4104462h-34.5686493c0,0-0.5861359,22.6971893-1.4486542,23.4933624
...
C261.8630981,187.5163422,267.2153931,203.7281647,253.458725,207.4104462z"
                                        ...
                                        <path
                                          fill="#fe4c40"
                                          d="M259.0874329,172.8197937l2.7756653,14.6965485
...
C267.8788757,172.7424316,259.0874329,172.8197937,259.0874329,172.8197937z"
                                        ...
                                        <path
                                          fill="#ea241f"
                                          d="M274.3701782,167.0914612c-7.9952087,5.6620483-15.2827454,5.7283325-15.2827454,5.7283325
...
C275.9515076,165.9302673,275.1553345,166.5385437,274.3701782,167.0914612z"
                                        ...
                                        <path
                                          fill="#4a5258"
                                          d="M237.9437103,183.34729h-30.5544281c-0.6524048,0-1.2164001-0.4311523-1.382309-1.061554
...
c0.0995483,0.132843,0.1769714,0.2875366,0.2211761,0.4645081l5.6177063,20.5797119L237.9437103,183.34729z"
                                        ...
                                        <path
                                          fill="#ea241f"
                                          d="M226.8152771,159.2952118c0,0,1.7509155-6.2589722,2.3959961-7.0422668l1.7506866,7.2154999
L226.8152771,159.2952118z"
                                        />
                                        <path
                                          fill="#fec9ac"
                                          d="M249.322876,141.5245209c0,0,0.2985382,5.2747498-8.2496033,4.9430847
...
c0.1106262,1.0172882,0.8847198,1.8356018,1.9020844,2.0237732H249.322876z"
                                        ...
                                        <path
                                          fill="#ffab90"
                                          d="M243.8378754,135.1105804c-0.1659088,0.3980865-2.8530884,6.7786865-7.6192627,7.0772858
c0.0442657-0.0110626,0.0774078-0.0221405,0.1216888-0.0332031c0.9952087-0.2764587,1.6918945-1.1721344,1.6918945-2.2006226
v-1.9020081C238.032196,138.0520325,241.792099,137.5655212,243.8378754,135.1105804z"
                                          opacity=".5"
                                        />
                                        <path
                                          fill="#4f2d2b"
                                        ...
                                        <g>
                                          <path
                                            fill="#4f2d2b"
                                            d="M236.4245911,125.5209198c-0.0432739,0.0666504-0.2914429-0.0598145-0.7874756-0.2258301
    ...
    C236.2862244,125.2277069,236.4630432,125.4669647,236.4245911,125.5209198z"
                                        ...
                                        <g>
                                          <path
                                            fill="#4f2d2b"
                                            d="M241.7104797,126.5326385c-0.0690308,0.0424805-0.225647-0.1738281-0.6032104-0.482666
    ...
    C241.7250061,126.2101288,241.7673035,126.50383,241.7104797,126.5326385z"
                                        ...
                                        <g>
                                          <path
                                            fill="#fec9ac"
                                            d="M214.2378845,159.2952118l-6.2892609-9.024765c0,0,0.9238739-4.8137512,0-4.9572906
...
H214.2378845z"
                                      ...
                                      <g>
                                        <path
                                          fill="#2e363a"
                                          d="M256.1348267,182.1421051c0,0.6633453-0.5418396,1.2051849-1.2053223,1.2051849h-16.9857941
l-0.6634674-2.4106598h17.6492615C255.5929871,180.9366302,256.1348267,181.4784851,256.1348267,182.1421051z"
                                      ...
                                      <g>
                                        <path
                                          fill="#fec9ac"
                                          d="M272.638092,186.1418152c-2.6319275,1.0063477-6.657196,1.2165375-10.8372498,1.039566
...
C276.7850037,179.6726532,276.4532471,184.6821594,272.638092,186.1418152z"
                                      ...
                                      <g opacity=".5">
                                        <path
                                          fill="#ffab90"
                                          d="M276.2099304,175.1830139c-8.1721191,0.6854706-17.1184082-2.3665161-17.1184082-2.3665161
s7.2875366-0.0662842,15.2827454-5.7283325C274.3742676,167.1877899,275.6902161,170.9696808,276.2099304,175.1830139z"
                                    ...
                                    <g>
                                      <path
                                        fill="#e4ecf9"
                                        d="M167.0072174,55.7068253H61.0756073c-2.2229652,0-4.0250282,1.8020248-4.0250282,4.0250282v99.5116272
...
V59.7318535C171.0322571,57.5088501,169.2301941,55.7068253,167.0072174,55.7068253z"
                                      ...
                                      <path
                                        fill="#fff"
                                        d="M166.8119507,64.5868454H61.2707329c-1.5590744,0-2.8229713,1.2639008-2.8229713,2.8229752v91.6384735
...
V67.4101105C169.6352234,65.8508148,168.3712158,64.5868454,166.8119507,64.5868454z"
                                      ...
                                      <g>
                                        <path
                                          fill="#64d3ff"
                                          d="M85.7465515,72.5103683v18.8269501c0,0.7534103-0.6082153,1.3546295-1.3615875,1.3546295H64.113533
...
h20.271431C85.1383362,71.148819,85.7465515,71.7569504,85.7465515,72.5103683z"
                                        ...
                                        <path
                                          fill="#fff"
                                          d="M69.2339325,87.4283295c-0.1345367-0.1398926-0.2018051-0.3122406-0.2018051-0.5170593
    ...
    L72.0688934,83.3256531z"
                                      ...
                                      <g>
                                        <path
                                          fill="#ffd964"
                                          d="M164.0271149,103.7443085v22.2207413c0,1.1053619-0.8994293,2.0047913-2.0047913,2.0047913
    ...
    C163.1276855,101.7395706,164.0271149,102.6347351,164.0271149,103.7443085z"
                                        ...
                                        <g>
                                          <path
                                            fill="#e4ecf9"
                                            d="M125.1148148,115.7453613c0,0.3268967-0.2646561,0.5916367-0.5915909,0.5916367H63.0477638
...
C124.8501587,115.1615143,125.1148148,115.4261703,125.1148148,115.7453613z"
                                        ...
                                        <g>
                                          <path
                                            fill="#e4ecf9"
                                            d="M125.1148148,120.037468c0,0.326889-0.2646561,0.5916367-0.5915909,0.5916367H63.0477638
...
C124.8501587,119.4536209,125.1148148,119.7182693,125.1148148,120.037468z"
                                        ...
                                        <g>
                                          <path
                                            fill="#e4ecf9"
                                            d="M125.1148148,124.3295746c0,0.326889-0.2646561,0.5916367-0.5915909,0.5916367H63.0477638
c-0.3269386,0-0.5916367-0.2647476-0.5916367-0.5916367c0-0.3191986,0.264698-0.583847,0.5916367-0.583847h61.4754601
C124.8501587,123.7457275,125.1148148,124.010376,125.1148148,124.3295746z"
                                    ...
                                    <g>
                                      <path
                                        fill="#7cd194"
                                        d="M215.4063873,73.7065582H200.889328c-1.5259857,0-2.7630463-1.2370529-2.7630463-2.7630386v-13.008316
...
v13.008316C218.1694336,72.4695053,216.932373,73.7065582,215.4063873,73.7065582z"
                                      ...
                                      <path
                                        fill="#fff"
                                        d="M204.1493073,68.9243546h7.8648529c0.2281494,0,0.4202271-0.2160492,0.3481903-0.4441223
...
C203.7410278,68.7083054,203.9211731,68.9243546,204.1493073,68.9243546z"
                                    ...
                                    <g>
                                      <path
                                        fill="#f3f6fd"
                                        d="M90.1817551,203.5628662H72.6960297c-1.5259857,0-2.7630386-1.2370605-2.7630386-2.7630463v-15.7535095
...
v15.7535095C92.9447937,202.3258057,91.7077408,203.5628662,90.1817551,203.5628662z"
                                    ...
                                    <g>
                                      <path
                                        fill="#fff"
                                        d="M36.1733704,96.3806229l-4.630537,3.1547623c-0.4197254,0.2843628-0.988409-0.0134735-0.988409-0.5212097
...
C36.545742,95.5886078,36.545742,96.1302261,36.1733704,96.3806229z"
                                    ...
                                    <g>
                                      <path
                                        fill="#7cd194"
                                        d="M55.7223282,221.3692627l-3.2197151,1.5854645l1.5502548,0.8647156
...
C63.5156174,205.7992859,60.192646,214.3749542,55.7223282,221.3692627z"
                                      ...
                                      <path
                                        fill="#71c687"
                                        d="M49.5696564,216.218338l-2.3768005,2.6890564l1.7624664,0.2114563
...
C50.868763,198.8553925,51.0500984,208.0505676,49.5696564,216.218338z"
                                      ...
                                      <path
                                        fill="#61ba76"
                                        d="M43.6418953,233.5799255c2.2820702-4.3032074,4.6745338-8.5357361,7.1841087-12.7029266
...
c-2.3956528,4.2215118-4.6766396,8.5133362-6.8359108,12.8531189L43.6418953,233.5799255z"
                                      ...
                                      <path
                                        fill="#f3f6fd"
                                        d="M49.2575111,232.7553711l-2.2861938,8.4093475l-0.8460732,3.1322632
...
C49.0962143,232.1308289,49.3380356,232.4431,49.2575111,232.7553711z"
                                      ...
                                      <path
                                        fill="#e4ecf9"
                                        d="M46.9713173,241.1647186l-0.8460732,3.1322632
c-0.0603638,0.2215424-0.2517815,0.3726349-0.4834023,0.3726349h-8.520237
c-0.2215385,0-0.4129562-0.1510925-0.47332-0.3726349l-3.132267-11.5416107
...
C46.0648804,240.8626556,46.5180359,241.0137482,46.9713173,241.1647186z"
                                      ...
                                      <g>
                                        <path
                                          fill="#7cd194"
                                          d="M39.5386238,228.4968567c-3.3598442-0.3310242-5.7053986-8.0226593-6.6421776-15.4537659h1.1058617
...
C45.2158203,228.1869812,41.6658249,228.7011566,39.5386238,228.4968567z"
                                        ...
                                        <path
                                          fill="#61ba76"
                                          d="M39.1726151,232.1607056c-0.350132-4.83461-0.8310738-9.6710815-1.4447937-14.4860229
...
c0.7397308,4.8079376,1.3463173,9.6318665,1.8239365,14.4792633L39.1726151,232.1607056z"
                                      ...
                                      <g>
                                        <path
                                          fill="#61ba76"
                                          d="M43.0290565,232.1009521c0.477623-4.8473969,1.0842056-9.6713257,1.8239365-14.4792633
                              ...
                              <div className="working-svg-container svg-container-3">
                                ...
                                >
                                  <g id="_x37_">
                                    ...
                                    <path
                                      fill="#ffd4cf"
                                      d="M191.6499481,375.9451599l1.8111572,2.8461914l3.9587555,6.2097168
                                    ...
                                    <g>
                                      ...
                                      <path
                                        fill="#262c51"
                                        d="M272.7557678,587.1473999c0,4.838623,29.2355957,4.838623,29.2355957,0v-12.0174561h-29.2355347
                                    ...
                                    <ellipse
                                      ...
                                      rx="9.829"
                                      ry="7.627"
                                      transform="rotate(-64.525 358.064 389.08)"
                                    />
                                    <g>
                                      <path
                                        fill="#ffd4cf"
                        ...
                        >
                          <div className="text-center p-0">
                            <h2 className="text-center fw-semibold text-white">
                              Features Used in Spruha Nextjs Admin Template
                            </h2>
                            ...
                            <Col lg={12}>
                              <Row className="row justify-content-center">
                                ...
                                >
                                  ...
                                  dashboard templates. It is also a premium
                                  admin dashboard with high-end features, where
                                  users can easily customize or change their
                                  projects according to their choice. Please
                                  take a quick look at our template highlights.
                                </Col>
                              </Row>
                              {/* collapse */}
                              <Row id="grid">
                                      ...
                                      {isFirstCollapsed ? (
                                        <Card.Body className="pt-0">
                                          <p>
                                            ...
                                            Both menus are managed by single
                                            assets. Where users can easily
                                          ...
                                          <p className="mt-2 mb-3">
                                            ...
                                            Please Refer full Documentation for
                                            more details.
                                          </p>
                                          <Link
                                    ...
                                    <Card className=" bg-secondary-transparent bg-transparent border  p-0 reveal">
                                      ...
                                      >
                                        <Card.Subtitle className="card-options  h5 fw-bold  mb-0 text-secondary">
                                          ...
                                          Switch Easily From Full Width to Boxed
                                          Layout
                                        </Card.Subtitle>
                                      </Card.Header>
                                      {is4Collapsed ? (
                                      ...
                                      {is5Collapsed ? (
                                        <Card.Body className="pt-0">
                                          <p>
                                            The Spruha – Bootstrap 5 Admin &
                                            Dashboard Template is also available
                                            in different types of Side Menu
                                            Styles. Where the users can change
                                            their Side Menu styles by using
                                            single assets.
                                          </p>
                                          <p className="mt-2 mb-3">
                                            <span className="fw-bold">
                                    ...
                                    <Card className="card bg-danger-transparent bg-transparent border  p-0 reveal">
                                      ...
                                      >
                                        <Card.Subtitle className="card-options  h5 fw-bold mb-0 text-danger">
                                          Switch Easily From Fixed to Scrollable
                                          Layout
                                        </Card.Subtitle>
                                      </Card.Header>
                                      {is6Collapsed ? (
                    ...
                    <Row>
                      ...
                      <Row className="justify-content-center">
                        ...
                        >
                          ...
                          easily customize or change their projects according to
                          their choice. Please take a quick look at our template
                          highlights.
                        </Col>
                      </Row>
                      <section className="sptb demo-screen-demo">
                        <Row className="align-items-center">
                          ...
                          <Col md={12} lg={6} className="reveal revealright">
                            <img src={frequentlyaskedquestions.src} alt="w" />
                          </Col>
                        </Row>
                      </section>
                    </Row>
                    ...
                    <Row id="demo">
                      <Col lg={6}>
                        <div className="feature-1 border-0">
                          ...
                          <h6 className="mb-0">
                            Support :{" "}
                            <Link
                              href="mailto:support@spruko.com"
                      ...
                      <Col lg={6} className=" mt-5 mt-xl-0 mt-lg-0">
                        <div className="feature-1 border-0">
                          ...
                          <p className="mb-1 text-white">
                            Please feel free to ask any questions before making
                            the purchase.
                          </p>
                          <h6 className="mb-0">
                            Ask :{" "}
                      ...
                      <footer className="main-footer px-0 text-center">
                        <Row>
                          <Col md={12} sm={12}>
                            ...
                            <Link href="#!">Spruha</Link>.Designed with{" "}
